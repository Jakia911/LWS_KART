...
const ShopPage = () => {
  return (
    ...
    <div
      className="container grid md:grid-cols-4 grid-cols-2 gap-6 pt-4 pb-16 items-start"
    >
     ...
     {/* drawer init and toggle */}
      ...
      <!-- ./sidebar -->
      <div
        className="col-span-1 bg-white px-4 pb-6 shadow rounded overflow-hiddenb hidden md:block"
      >
        <div className="divide-y divide-gray-200 space-y-5">
          <div>
            <h3 className="text-xl text-gray-800 mb-3 uppercase font-medium">
